...
public class Topic
{
    ...
    public Topic(int topicId, String topicSubject, String topicMessage, Date topicDate, Categories topicCategory, int topicBy, int topicLawyer)
    {
        /* 14 */ this.topicId = topicId;
        /* 15 */ this.topicSubject = topicSubject;
        /* 16 */ this.topicDate = topicDate;
    ...
    public int getTopicLawyer()
    {
        return topicLawyer;
    }

    public void setTopicLawyer(int pTopicLawyer)
    {
        topicLawyer = pTopicLawyer;
    }
}
